# Обновлённый текстовый вайрфрейм лендинга «Ретрознак»

Документ отражает структуру лендинга после внедрения UX/маркетинговых рекомендаций из wireframe-review.md. Основная цель — провести пользователя по сценарию «понял продукт → увидел доказательства → выбрал модель → оставил заявку», усилив доверие и количество микроконверсий.

---

## Глобальный сценарий и системные элементы

* **Логика скролла:** каждый блок завершает микро-CTA, ведущий к форме заявки или в мессенджер.
* **Плавающее меню (desktop + мобильная кнопка-гамбургер):** логотип + пункты «Модели», «История», «Производство», «Отзывы», «FAQ», «Заказ». Справа — мини-CTA «Получить расчёт» и иконки WhatsApp/Telegram с подписями «Написать» и «Позвонить».
* **Навигационный якорь на мобиле:** компактная панель внизу с кнопками «Расчёт», «WhatsApp», «Telegram», «Позвонить».
* **Микроконверсии по странице:** «Скачать каталог PDF», «Получить консультацию», «Узнать стоимость доставки», «Получить ссылку на видео», «Задать вопрос».
...
* **Лого:** обновлённое лого «Ретрознак» + подпись «Запатентованная мастерская ООО «Три Кита»».
* **Бейджи доверия:** «8 лет на рынке», «>900 изготовленных знаков», «Производство в Томске».
* **Контакты:** две кнопки «Позвонить» (иконка телефона, кликабельный номер) и «Написать» (иконки WhatsApp/Telegram). На мобиле — большие круговые кнопки.
* **CTA в шапке:** «Получить макет и консультацию» (модальное окно с формой в 3 поля + выбор мессенджера).

### Hero-блок

* **Главный заголовок:** «Домовой знак, который притягивает взгляды и служит десятилетиями».
* **Подзаголовок:** «Изготовим для вашего адреса за 7 дней, доставим по всей России».
* **Текст-триггеры:**
  * «Металл, стекло и эмаль — как в оригиналах 1950-х».
  * «Пожизненная гарантия на нержавеющий корпус».
  * «Проверено 4,9/5 по отзывам ВКонтакте».
* **Социальные доказательства:** логотипы СМИ (Esquire, The Village), QR-код на YouTube-канал, бейдж рейтинга.
* **Счётчик дефицита:** «В производстве 17 знаков, бронируйте до конца недели» (автообновляемый).
* **Визуал:** большой рендер/фото подсвеченного знака на фасаде + мини-слайдер «Ретрознак vs обычная табличка» с маркерами «видимость», «срок службы», «статус».
* **CTA-кнопки:**
...
* **Лид-магнит:** блок рядом с формой «Получите PDF с 15 примерами ретрознаков на исторических зданиях» → мини-форма (имя + выбор WhatsApp/Telegram).

---

## 2. Таймлайн истории и ценности наследия

* **Заголовок:** «От патента 1924 года до современных ретрознаков».
...
* **Заголовок:** «Кому подходят ретрознаки».
* **Секции с иконками:**
...
* **Подзаголовок:** «Сравните модели и подберите конфигурацию за минуту».
...
* **Каждая карточка содержит:**
  * Визуал (фото/рендер + возможность покрутить 360°).
...
* **Заголовок:** «Как создаётся ваш ретрознак».
* **Процесс в 4 шага:**
  1. «Разрабатываем макет» — дизайнер готовит 2 варианта за 2 часа.
...
* **Цифры:** «100 знаков в месяц», «37% клиентов возвращаются за новыми проектами», «0 гарантийных случаев за 2023 год».
* **Проверки и сертификаты:** ГОСТ, патент, гарантийный талон (иконки + ссылки для скачивания PDF).
* **Интегрированное видео:** встроенный плеер с превью; таймкоды «00:45 — как светится ночью», «02:10 — упаковка», «03:30 — установка». Кнопки «Смотреть без звука», «Получить ссылку в WhatsApp/Telegram».

---

## 6. Отзывы и социальное доказательство

* **Заголовок:** «За ретрознаками — по всей России».
* **Рейтинг:** «4,9 / 5 из 186 отзывов».
* **Категории вкладок:**
  * Частные дома (фото до/после, цитаты).
  * Коммерческие пространства (рестораны, бары, каворкинги).
  * Муниципалитеты и ТСЖ.
* **Карта отзывов:** интерактивная карта с городами клиентов.
* **Блок «Пресса и награды»:** логотипы СМИ, фестивали дизайна, бейдж «Лучший проект по сохранению наследия 2023».
* **Видеоотзывы:** вертикальные ролики (субтитры по умолчанию).
* **CTA блока:** «Хочу такой же знак, как у [Имя клиента]».
...
* **Заголовок:** «От заявки до установленного ретрознака — 6 шагов».
...
* **Финальный заголовок:** «Превратите адрес в часть семейной истории».
...
* **Отслеживаемые события:** клики по CTA, отправки форм, скачивание PDF, просмотр видео, взаимодействие с табами.
* **A/B тесты:** заголовок героя, наличие бейджа «Бесплатный макет», порядок карточек матрицы, вариант формы (1 шаг vs 2 шага), счётчик дефицита.
* **Тепловые карты:** подключить Яндекс.Метрику/Hotjar для анализа интереса к истории и матрице.
* **Thank You Page:** сообщение «Спасибо! Подпишитесь на Telegram — там акции и новые модели» + кнопки на мессенджеры.
* **Интеграции:** Jivo Chat как основной чат, CRM — приём заявок с сайта и мессенджеров.
